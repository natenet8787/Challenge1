...
total_loans_amount = sum(loan_costs)
print(f"The total amount of all the loans is ${total_loans_amount}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan = total_loans_amount / number_of_loans
print(f"The average loan price is ${average_loan}")
...
print(f"The reamining months on the loan is {remaining_months}")
